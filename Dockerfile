...
RUN apt-get update && \
    ...
    apt-get update && apt-get install php7.2 php7.2-common php7.2-apcu php7.2-curl php7.2-gd php7.2-imagick php7.2-json php7.2-mbstring php7.2-mysql php7.2-readline php7.2-soap php7.2-xml php7.2-zip php7.2-redis php7.2-intl php7.2-sqlite3 -y && \
